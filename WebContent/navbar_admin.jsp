	...
	<nav class="navbar navbar-inverse">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="homepage_admin.jsp">Appy Days</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><button class="btn btn-default btn-md"><span class="glyphicon glyphicon-log-out" ></span> Logout</button></li>
					</form>
				</ul>
			</div>
		</div>
