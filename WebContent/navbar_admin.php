	...
	<nav class="navbar navbar-inverse">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="homepage_admin.php">Appy Days</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="reservation_admin.php">Reservations</a></li>
					<li><a href="about_admin.php">About</a></li>
					<li><a href="account_admin.php">My Account</a></li>
					<li><a href="admin.php">Admin Panel</a></li>
					<li><a href="reception_admin.php">Reception Panel</a></li>
				</ul>
