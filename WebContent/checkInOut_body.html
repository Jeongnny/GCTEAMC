	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
				<div class="col-sm-4">
					<button class="center-block btn btn-default btn-info manageButton">Check In</button>
				</div>

				<div class="col-sm-4">
					<button class="center-block btn btn-default btn-info manageButton">Check Out</button>
				</div>

				<div class="col-sm-4">
					<a href="reception.html" class="center-block btn btn-default btn-info manageButton">Back</a>
				</div>
			</div>
		</div>
	</div>
